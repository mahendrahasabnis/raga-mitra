...
if (!GEMINI_API_KEY) {
  console.error('❌ GEMINI_API_KEY is not set. Set it in .env or:');
  console.error('   export GEMINI_API_KEY=$(gcloud secrets versions access latest --secret=GEMINI_API_KEY --project=platforms-476017)');
  process.exit(1);
}
