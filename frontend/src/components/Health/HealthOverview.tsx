  ...
  return (
    <div className="space-y-4 overflow-x-hidden">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="card p-4 bg-gradient-to-br from-rose-500/20 to-rose-600/10 border border-rose-400/30">
        ...
        <div className="card p-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            {keyVitals.slice(0, 4).map((vital) => (
              <div key={vital.id || vital.parameter} className="rounded-lg border border-white/10 bg-white/5 p-3">
