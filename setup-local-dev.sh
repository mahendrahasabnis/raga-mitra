...
echo "2. Ensure frontend/.env.local has VITE_API_BASE_URL=http://localhost:5001/api"
echo "3. Run: npm run dev:local   (local frontend + local backend with online DB)"
echo ""
